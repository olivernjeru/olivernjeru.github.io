  ...
  return (
    <AppBar position="fixed" sx={{ backgroundColor: '#333', zIndex: (theme) => theme.zIndex.drawer + 1, top: 0 }}>
        ...
        {isMobile && (
          <Box sx={{ display: 'flex', alignItems: 'left', gap: '10px' }}>
            ...
            <a href="https://github.com/olivernjeru" target="blank" rel="noopener">
              <img src="socials/github.png" alt="GitHub" style={socialIconStyle} />
            </a>
            ...
            <a href="https://figma.com/@olivernjeru" target="blank" rel="noopener">
              <img src="socials/figma.svg" alt="Figma" style={socialIconStyle} />
            </a>
            <a href="https://dribbble.com/olivernjeru" target="blank" rel="noopener">
              <img src="socials/dribbble.svg" alt="Dribbble" style={socialIconStyle} />
            </a>
            <a href="https://unsplash.com/olivernjeru" target="blank" rel="noopener noreferrer">
              <img src="socials/unsplash.svg" alt="Unsplash" style={socialIconStyle} />
            </a>
          </Box>
        )}
      ...
      <Drawer open={menuOpen} onClose={toggleMenu}>
        <Box sx={{ width: 250, backgroundColor: '#333', color: 'white', position: 'relative' }} role="presentation">
          {/* Drawer Header */}
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '16px', borderBottom: '1px solid #444' }}>
